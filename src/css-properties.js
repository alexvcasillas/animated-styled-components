export default {
  ...
  mask: {
    ...
    media: 'visual',
    inherited: false,
    animationType: ['mask-position', 'mask-size'],
    percentages: ['mask-position'],
    groups: ['CSS Masks'],
    initial: ['mask-origin', 'mask-clip'],
    appliesto: 'allElementsSVGContainerElements',
    computed: ['mask-origin', 'mask-clip'],
    order: 'uniqueOrder',
    stacking: true,
    status: 'standard'
  },
